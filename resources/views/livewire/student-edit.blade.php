                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 position-relative mt-0">
                                ...
                                <input type="text" id="lastname" wire:model.live="lastname" @if($lastname) disabled @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 position-relative mt-0">
                                ...
                                <input type="text" class="form-control form-control-sm" wire:model.live="selectedProvince"
                            ...
                            <div class="col-md-4 position-relative mt-0">
                                ...
                                <input type="text" class="form-control form-control-sm" wire:model.live="selectedBarangay"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 position-relative mt-3">
                                ...
                                <input type="text" id="status" class="form-control form-control-sm" wire:model.live="status"
                            ...
                            <div class="col-md-3 position-relative mt-3">
                                ...
                                <input type="text" id="contact" class="form-control form-control-sm"
                                    wire:model.live="contact" maxlength="11" minlength="11" @if($contact) disabled @endif />
                            </div>
                            <!-- Email -->
                            <div class="col-md-3 position-relative mt-3">
                                <label class="form-label" for="email">Email Address</label>
                                <input type="email" id="email" class="form-control form-control-sm" wire:model.live="email"
                        ...
                        <form wire:submit.prevent="addScholarship">
                                ...
                                <div class="d-flex justify-content-end gap-2 mx-4">

                                    <a type="button" class="btn btn-danger btn-md fw-bold text-white mt-2" href="{{ url('student') }}">
                                        <i class="mdi mdi-close-circle"></i>
                                        Cancel
                                    </a>
                                    <button type="submit" wire:loading.attr='disabled' class="btn btn-success btn-md fw-bold text-white mt-2">
